...
const handler = async (m, {conn}) => {
  ...
  if (!(m.chat in global.math)) return conn.reply(m.chat, `_*< JOGOS - MATEMÁTICA />*_\n\n*[ ℹ️ ] Já foi resolvido anteriormente.*`, m);
  ...
  if (m.quoted.id == global.math[id][0].id) {
    ...
    if (m.text == math.result) {
      conn.reply(m.chat, `_*< JOGOS - MATEMÁTICA />*_\n\n▢ *Resposta correta!*\n\n▢ *Ganhaste:* ${math.bonus} XP`, m);
      ...
      if (--global.math[id][2] == 0) {
        conn.reply(m.chat, `_*< JOGOS - MATEMÁTICA />*_\n\n▢ *Já não tens mais chances.*\n\n▢ *Resposta correta:* ${math.result}`, m);
        ...
        clearTimeout(global.math[id][3]);
        delete global.math[id];
      } else conn.reply(m.chat, `_*< JOGOS - MATEMÁTICA />*_\n\n▢ *Resposta incorreta.*\n\n▢ Tens ${global.math[id][2]} oportunidade(s).`, m);
    }
  }
};
