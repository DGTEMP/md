...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  if (!args[0]) throw `_*< INSTAGRAM />*_\n\n*[ ℹ️ ] Ingrese un link do Instagram.*\n\n*[ 💡 ] Exemplo:* _${usedPrefix + command} https://www.instagram.com/reel/Cc0NuYBg8C/?utm_source=ig_web_copy_link_`;
  m.reply(global.wait);
  try {
