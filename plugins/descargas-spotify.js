...
const handler = async (m, { conn, text, usedPrefix, command }) => {
 if (!text) throw `_*< SPOTIFY />*_\n\n*[ ℹ️ ] Cadê o título da Música Spotify.*\n\n*[ 💡 ] Exemplo:* _${usedPrefix + command} Good Feeling - Flo Rida_`;
  try {
