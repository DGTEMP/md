...
handler.all = async function(m) {
  ...
  if (/^cristiano$/i.test(m.text) && !chat.isBanned) {
    conn.sendPresenceUpdate('recording', m.chat);
    await m.reply(`*Hmmm, espertinho, ta querendo o que com meu Mestre? Quer dar o tobias pra ele tu fala.*`);
