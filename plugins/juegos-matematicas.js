...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  const mat =`_*< JOGOS - MATEMÁTICOS />*_\n\n*[ ℹ️ ] Falta indicar o nivel de dificuldade.*\n\n*[ 💡 ] Exemplo:* _${usedPrefix + command} medium_\n\n▢ *Níveis disponíves:* ${Object.keys(modes).join(' | ')}`.trim();
...
handler.command = /^math|mates|matemática/i;
