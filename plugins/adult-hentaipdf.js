...
const handler = async (m, {conn, text, usedPrefix, command, args}) => {
  if (!db.data.chats[m.chat].modohorny && m.isGroup) throw '*[❗𝐈𝐍𝐅𝐎❗] 𝙾𝚂 𝙲𝙾𝙼𝙰𝙽𝙳𝙾𝚂 +𝟷𝟾 𝙴𝚂𝚃𝙰 𝙳𝙴𝚂𝙰𝚃𝙸𝚅𝙰𝙳𝙾 𝙽𝙴𝚂𝚃𝙴 𝙶𝚁𝚄𝙿𝙾, 𝚂𝙴 𝙰𝙳𝙼𝙸𝙽 𝙴 𝙰𝚃𝙸𝚅𝙰𝚁 𝚄𝚂𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 #true modohorny*';
  if (!text) throw `*[❗] 𝙸𝙽𝙶𝚁𝙴𝚂𝙰 𝙽𝙾𝙼𝙴 𝙳𝙴 𝙰𝙻𝙶𝚄𝙽𝙰 𝙲𝙰𝚃𝙴𝙶𝙾𝚁𝙸𝙰 𝙳𝙴 𝙷𝙴𝙽𝚃𝙰𝙸, EXEMPLO: ${usedPrefix + command} miku*`;
  try {
    m.reply(global.wait);
