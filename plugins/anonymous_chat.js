async function handler(m, {usedPrefix, command}) {
  ...
  switch (command) {
    ...
    case 'leave': {
      ...
      if (!room) return this.sendMessage(other, {text: `*[❗𝐈𝐍𝐅𝐎❗] 𝙽𝙾 𝙴𝚂𝚃𝙰𝚂 𝙽𝚄𝙼 𝙲𝙷𝙰𝚃 𝙰𝙽𝙾𝙽𝙸𝙼𝙾*\n\n*𝚀𝚄𝙴𝚁𝙴𝚂 𝙸𝙽𝙸𝙲𝙸𝙰𝚁?*\n${usedPrefix}start`}, {quoted: m});
      ...
      m.reply('*[ ✔ ] 𝚂𝙰𝙸𝚄 𝙲𝙷𝙰𝚃 𝙰𝙽𝙾𝙽𝙸𝙼𝙾*');
      const other = room.other(m.sender);
      if (other) await this.sendMessage(other, {text: `*[❗𝐈𝐍𝐅𝐎❗] 𝙾 𝙾𝚄𝚃𝚁𝙾 𝚄𝚂𝚄𝙰𝚁𝙸𝙾 𝙰𝙱𝙰𝙽𝙳𝙾𝙽𝙾𝚄 𝙾 𝙲𝙷𝙰𝚃 𝙰𝙽𝙾𝙽𝙸𝙼𝙾*\n\n*𝚀𝚄𝙴𝚁𝙴𝚂 𝙸𝚁 𝙰𝙾 𝙾𝚄𝚃𝚁𝙾 𝙲𝙷𝙰𝚃 𝙰𝙽𝙾𝙽𝙸𝙼𝙾?*\n ${usedPrefix}start`}, {quoted: m});
    ...
    case 'start': {
      ...
      if (room) {
        await this.sendMessage(room.a, {text: `*[ ✔ ] 𝚄𝙼𝙰 𝙿𝙴𝚁𝚂𝙾𝙽𝙰 𝚂𝙴 𝚄𝙽𝙸𝚄 𝙰𝙾 𝙲𝙷𝙰𝚃 𝙰𝙽𝙾𝙽𝙸𝙼𝙾, 𝙿𝙾𝙳𝙴𝙼 𝙸𝙽𝙸𝙲𝙸𝙰𝚁 𝙾 𝙲𝙷𝙰𝚃*`}, {quoted: m});
        ...
        room.b = m.sender;
        room.state = 'CHATTING';
        await this.sendMessage(m.chat, {text: `*[ ✔ ] 𝚄𝙼𝙰 𝙿𝙴𝚂𝙾𝙰 𝚂𝙴 𝚄𝙽𝙸𝚄 𝙰𝙾 𝙲𝙷𝙰𝚃 𝙰𝙽𝙾𝙽𝙸𝙼𝙾, 𝙿𝙾𝙳𝙴𝙼 𝙸𝙽𝙸𝙲𝙸𝙰𝚁 𝙰 𝙲𝙷𝙰𝚃𝙴𝙰𝚁*\n\n𝙸𝚁 𝙰𝙾 𝙾𝚄𝚃𝚁𝙾 𝙲𝙷𝙰𝚃 ${usedPrefix}next`}, {quoted: m});
        ...
        await this.sendMessage(m.chat, {text: `*[❗𝐈𝐍𝐅𝐎❗] 𝙴𝚂𝙿𝙴𝚁𝙰𝙽𝙳𝙾 𝙾𝚄𝚃𝚁𝙾 𝚄𝚂𝚄𝙰𝚁𝙸𝙾 𝙿𝙰𝚁𝙰 𝙸𝙽𝙸𝙲𝙸𝙰𝚁 𝙾 𝙲𝙷𝙰𝚃 𝙰𝙽𝙾𝙽𝙸𝙼𝙾*\n\n*𝚀𝚄𝙴𝚁𝙴𝚂 𝚂𝙰𝙸𝚁 𝙳𝙾 𝙲𝙷𝙰𝚃 𝙰𝙽𝙾𝙽𝙸𝙼𝙾?*\n~ESCREVA~ ${usedPrefix}leave`}, {quoted: m});
