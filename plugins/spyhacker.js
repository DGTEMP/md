...
handler.all = async function(m) {
  ...
  if (/^spyhacker$/i.test(m.text) && !chat.isBanned) {
    conn.sendPresenceUpdate('recording', m.chat);
    await m.reply(`*Então tu me conehece, boa lek, pra não conhece ainda corre lá no ig @SpyHacker.ads to soltando só as mais brabar como sempre, _spy ne vd_*`);
